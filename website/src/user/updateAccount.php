...
if ($updateType = 4) {
    $updateUser = "UPDATE users SET username = :username, email = :email WHERE username = :username";
    $options = [
...
elseif ($updateType = 6) {
    $updateUser = "UPDATE users SET username = :username, email = :email, password = :password WHERE username = :username";
    $options = [
        ':username' => $_POST['username'],
        ':email' => $openssl->opensslEncryptAES256($_POST['email'], include('../opensslkey.php')),
